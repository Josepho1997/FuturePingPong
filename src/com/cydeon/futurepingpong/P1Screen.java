...
public class P1Screen extends GLScreen{
        ...
        for(int i = 0; i < len; i++) {
            ...
            if(event.type == TouchEvent.TOUCH_UP) {
                ...
                if(OverlapTester.pointInRectangle(grcBounds, touchPoint)) {
            		...
            		ranB = ran.nextFloat();
            		ranA = ran.nextFloat();
                	Settings.rgbPaddle1[0] = ranR;
      		        Settings.rgbPaddle1[1] = ranG;
      		        Settings.rgbPaddle1[2] = ranB;
	...
	public void present(float deltaTime) {
	        ...
	        gl.glPushMatrix();
	        batcher.drawSprite((576 /3) / 2, 768 - ((84 / 3) / 2), 576 / 3, 84 / 3, Assets.paddle1Color);
...
//	        /Log.d("Red", Float.toString(Settings.rgbPaddle1[0]));
	        batcher.drawSprite(1280 / 2, 768 / 2, 54, 260, Assets.paddle);
	        gl.glPopMatrix();
	        batcher.endBatch();
	        ...
	        Assets.font.drawText(batcher, p1C, 1280 - (16 * (p1C.length() - 1)), 600);
	        
	        //Red RGB Paddle
	        String ranRgbR = Integer.toString(Math.round(Settings.rgbPaddle1[0] * 100));
	        String ranBRRGB = Integer.toString(Math.round(Settings.rgbPaddle1[0] * 256));
	        ...
	        gl.glColor4f(1, 1, 1, 1);
	        //Green RGB Paddle
	        String ranRgbG = Integer.toString(Math.round(Settings.rgbPaddle1[1] * 100));
	        String ranBGRGB = Integer.toString(Math.round(Settings.rgbPaddle1[1] * 256));
	       // Log.d("Test", ranRgbG + " " + ranBGRGB);
	        ...
	        //Blue RGB Paddle
	        String ranRgbB = Integer.toString(Math.round(Settings.rgbPaddle1[2] * 100));
	        String ranBBRGB = Integer.toString(Math.round(Settings.rgbPaddle1[2] * 256));
