...
public class P2Screen extends GLScreen {
    ...
    for(int i = 0; i < len; i++) {
        ...
        if(event.type == TouchEvent.TOUCH_UP) {
            ...
            if(OverlapTester.pointInRectangle(grcBounds, touchPoint)) {
        		...
        		ranB = ran.nextFloat();
        		ranA = ran.nextFloat();
            	Settings.rgbPaddle2[0] = ranR;
  		        Settings.rgbPaddle2[1] = ranG;
  		        Settings.rgbPaddle2[2] = ranB;
...
public void present(float deltaTime) {
        ...
        gl.glPushMatrix();
        batcher.drawSprite((576 /3) / 2, 768 - ((84 / 3) / 2), 576 / 3, 72 / 3, Assets.paddle2Color);
...
//        /Log.d("Red", Float.toString(Settings.rgbPaddle1[0]));
        ...
        Assets.font.drawText(batcher, p2C, 1280 - (16 * (p2C.length() - 1)), 600);
        
        //Red RGB Paddle
        String ranRgbR = Integer.toString(Math.round(Settings.rgbPaddle2[0] * 100));
        String ranBRRGB = Integer.toString(Math.round(Settings.rgbPaddle2[0] * 256));
        ...
        gl.glColor4f(1, 1, 1, 1);
        //Green RGB Paddle
        String ranRgbG = Integer.toString(Math.round(Settings.rgbPaddle2[1] * 100));
        String ranBGRGB = Integer.toString(Math.round(Settings.rgbPaddle2[1] * 256));
       // Log.d("Test", ranRgbG + " " + ranBGRGB);
        ...
        //Blue RGB Paddle
        String ranRgbB = Integer.toString(Math.round(Settings.rgbPaddle2[2] * 100));
        String ranBBRGB = Integer.toString(Math.round(Settings.rgbPaddle2[2] * 256));
